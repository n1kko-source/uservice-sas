        ...
        <div ref={ref} className="fade-up grid items-start gap-16 md:grid-cols-2">
          <div>
            ...
            <p className="mt-6 max-w-xl text-muted-foreground md:text-lg">
              UService es un equipo de ingenieros, diseñadores y estrategas
              apasionados por transformar ideas en productos digitales que
              generan valor real para las personas y las empresas.
            </p>
          </div>
